    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-4 font-bold">View and track your order history</p>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-4 font-bold">Manage your shipping addresses</p>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-4 font-bold">Update your account information</p>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-4 font-bold">Manage your payment options</p>
          <button className="btn btn-primary block w-full py-2 font-bold">
            Manage Payments
          </button>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-4 font-bold">Contact customer service</p>
